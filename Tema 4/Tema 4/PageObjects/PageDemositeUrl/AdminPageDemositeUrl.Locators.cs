...
namespace Tema_4.PageObjects.PageDemositeUrl
{
    partial class AdminPageDemositeUrl
    {
        ...
        public IWebElement DeleteUserButton => _driver.FindElement(By.XPath("/html/body/div/div/div/table/tbody/tr[td[text()='danielb']]/td[8]/a[2]"));
        ...
        public IWebElement UserDeletedIsDisplayed => _driver.FindElement(By.XPath("/html/body/div/div/div/table/tbody/tr[td[text()='danielb']]"));
